                                    ...
                                    <form action = "/create_channel" method = "POST" >
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select class="select2 form-control custom-select select2-hidden-accessible" name="channel" tabindex="-1" aria-hidden="true" required>
                                                    <option value="">Pilih Channel</option>
                                                        ...
                                                        <option value="comp147">147</option>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="text" id="mask" name="komplain" class="form-control" id="validationTooltip01" required>
                                            </div>
                                            @if(Auth::user()->role == "admin")
                            ...
                            <div class="row ">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row justify-content-end">
                                        <form action ="{{ route('index.channel') }}" method="GET">
                                        ...
                                        <table  class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody style="background-color: #FFFFFF; color: #000000; font-size: 12px; border-style: solid; border-color: #C0C0C0; border-width: 1px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ number_format($dt->comp147) }}</td> 
                                                    <td>{{ number_format($dt->sosmed) }}</td> 
                                                    <td>{{ number_format($dt->plasa) }}</td> 
                                                    <td>{{ number_format($dt->myih) }}</td> 
                                                    <td>{{ number_format($dt->all_channel) }}</td> 
                                            ...
                                            <tfoot style="background-color: #F0F8FF; vertical-align: middle; font-weight: bold; text-align: center; font-size: 12px;">
                                                ...
                                                @foreach($datasum as $ds)
                                                    ...
                                                    <td>{{ number_format($ds->com147) }}</td> 
                                                    <td>{{ number_format($ds->sosmed) }}</td> 
                                                    <td>{{ number_format($ds->plasa) }}</td> 
                                                    <td>{{ number_format($ds->myih) }}</td> 
                                                    <td>{{ number_format($ds->total_nas) }}</td> 
                                                @endforeach
                                            </tfoot>
                                        </table>
                                    <!-- </div> -->
